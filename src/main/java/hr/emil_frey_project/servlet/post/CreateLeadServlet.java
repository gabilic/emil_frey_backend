...
@WebServlet(name = "CreateLeadServlet", urlPatterns = "/createLead")
public class CreateLeadServlet extends HttpServletUtil {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        boolean result = new LeadDao().createLead(json.getString("firstName"), json.getString("lastName"), carIds);
